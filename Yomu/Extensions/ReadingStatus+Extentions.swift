...
public extension ReadingStatus {
    ...
    var systemImageName: String {
        switch self {
        case .none: "bookmark.slash.fill"
        case .reading: "book.fill"
        case .on_hold: "bookmark.fill"
        case .dropped: "archivebox.fill"
        case .plan_to_read: "books.vertical.fill"
        case .completed: "book.closed.fill"
        case .re_reading: "arrow.trianglehead.clockwise"
        }
    }
    ...
    var color: Color {
        ...
        case .on_hold:.orange
        case .dropped: .red
        case .plan_to_read: .purple
        case .completed:.cyan
        case .re_reading:.mint
        }
    }
}
